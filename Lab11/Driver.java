...
public class Driver
{
  	...
  	{ 
  		...
  		Rectangle	rectangle = new Rectangle("Rectangle One", "Blue", 15.0, 20.0);
  		Cylinder	cylinder = new Cylinder("Cylinder One", "Grey", 6, 8);
  		Sphere		sphere = new Sphere("Sphere One", "Black", 77);
  		Triangle	triangle = new Triangle("Illuminati", "Green", 10.0, 5.0);
